...
describe("public contract schemas", () => {
  const reportContentItem: ContentItem = {
    ...
    report: {
      ...
      targets: ["NVDA"],
      today_change: "No fixture ledger status changed.",
      evidence_status: "No new public source packet was added in this fixture.",
      main_risks: ["Fixture risk remains visible."],
      why_today_matters: "The fixture proves report-aware content has reader-facing fields.",
      background_context: ["Fixture company context."],
      recent_changes: ["No new fixture evidence."],
      positive_view: ["Fixture positive view."],
      opposing_view: ["Fixture opposing red-team view."],
      observation_triggers: ["Fixture resolver trigger."],
      risks_uncertainty: ["Fixture uncertainty."],
      reader_takeaways: ["Fixture reader takeaway."],
      comparability: ["Fixture comparability statement."],
      error_attribution: ["Fixture error attribution statement."],
      system_learning: ["Fixture system learning."],
      tomorrow_watch: ["Fixture next watch item."],
      watched_scope: [
        {
