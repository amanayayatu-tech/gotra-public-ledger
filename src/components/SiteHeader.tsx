    ...
    children: [
      {
        ...
        path: "/ledger",
        zh: "冻结演示账本",
        en: "Frozen demo ledger",
        zhDescription: "查看冻结演示记录；最新生产报告在报告入口。",
      ...
      },
      {
        ...
        path: "/performance",
        zh: "表现跟踪（暂无生产）",
        en: "Performance tracking (no production yet)",
        zhDescription: "暂无生产表现；demo fixture 只作为折叠样本。",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        zh: "简报复盘",
        en: "Notes & reviews",
        zhDescription: "先看最新生产日报，再看静态透明度文章归档。",
        enDescription: "Read latest production reports first, then static transparency archive notes.",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        zh: "来源与证据",
        en: "Sources & evidence",
        zhDescription: "查看 live reports artifacts、静态 manifest 和证据索引。",
